...
## Tip
TLB: `tip#8486d18f query_id:uint64 amount:coins destination:address custom_payload:Maybe ^cell forward_ton_amount:coins response_destination:Maybe address forward_payload:remainder<slice> = Tip`
Signature: `Tip{query_id:uint64,amount:coins,destination:address,custom_payload:Maybe ^cell,forward_ton_amount:coins,response_destination:Maybe address,forward_payload:remainder<slice>}`

## Mint
TLB: `mint#f04e38b6 amount:int257 receiver:address receiver_str:^string txid:^string proof_length:uint8 proof:^cell = Mint`
Signature: `Mint{amount:int257,receiver:address,receiver_str:^string,txid:^string,proof_length:uint8,proof:^cell}`
...
## MintSetting
TLB: `mint_setting#176c5ed6 set_interval:uint32 max_mint_today:uint64 = MintSetting`
Signature: `MintSetting{set_interval:uint32,max_mint_today:uint64}`

## ClaimInfo
TLB: `_ merkle_root:^string set_at:uint32 set_interval:uint32 admin:address max_mint_today:uint64 minted_today:uint64 = ClaimInfo`
...
3688: Not mintable
4329: Only for Admin Use
4429: Invalid sender
10436: Invalid Mint!
12241: Max supply exceeded
12956: Invalid unavailable_balance
14534: Not owner
16059: Invalid value
